...
| EnableBackwardsCompatibleContentEncoding | Bool       | If YES, this will use the backwards compatible content encoding of 'zlib' for requests sent to the sync server.<br /><br />If syncing with Upvote deployed at commit [0b4477d](https://github.com/google/upvote/commit/0b4477d40676a46ad58aaa7e14f9b13770d55c0c) or below, set this to YES and see patch notes for release [1.17](https://github.com/google/santa/releases/tag/1.17).<br /><br />Defaults to NO and uses 'deflate' as the content-encoding.  |
